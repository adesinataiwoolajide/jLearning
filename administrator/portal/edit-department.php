        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <ul class="breadcrumb float-md-right">
                    ...
                    <li class="breadcrumb-item"><a href="edit-department.php?dept_id=<?php echo $dept_id ?>">Edit Department</a></li>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form class="form-horizontal" action="update_department.php" method="POST"  enctype="multipart/form-data">
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12">
                                    <div class="form-group">
                                    <button type="submit" class="btn btn-primary btn-lg btn-block text-uppercase" name="update_dept">UPDATE DEPARTMENT</button>
                                    </div>
                                </div>
                            </div>
                        </form>
