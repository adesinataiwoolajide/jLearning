    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>System</strong> Administrator <small>Please Fill the below for to add a new Admin...</small> </h2>
                        
                    </div>
                    <div class="body">
                        <form class="form-horizontal" action="process_user.php" method="POST"  enctype="multipart/form-data">
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <input type="password" class="form-control" placeholder="Repeat Password" name="repeat" required>
                                    </div>
                                </div>

                                <div class="col-lg-12 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary btn-lg btn-block text-uppercase" name="add_user">ADD 
                                        USER</button>
                                    </div>
                                    ...
                                    foreach(getAllUser() as $users){?>
                                        <tr>
                                            <td><?php echo $num; ?>
                                                ...
                                                <a href="edit-user.php?user_id=<?php echo $users['user_id'] ?>" class="btn btn-success" 
